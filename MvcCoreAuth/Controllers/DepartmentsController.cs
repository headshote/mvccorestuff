...
namespace MvcCoreAuth.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id, byte[] rowVersion)
        {
            ...
            //When the Entity Framework creates a SQL UPDATE command, that command will include a WHERE clause
            //that looks for a row that has the original RowVersion value. If no rows are affected by the UPDATE command 
            //(no rows have the original RowVersion value), the Entity Framework throws a DbUpdateConcurrencyException exception.
